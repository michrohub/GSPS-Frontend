            ...
            {isOpen ? (
                ...
                <div className='flex flex-col gap-[15px]'>
                    ...
                    <button
                        ...
                        className=" h-[60px] w-[60px] flex items-center justify-center bg-indigo-600 text-white  rounded-full shadow-2xl hover:bg-indigo-700 transition-all active:scale-95 group relative"
                    >
