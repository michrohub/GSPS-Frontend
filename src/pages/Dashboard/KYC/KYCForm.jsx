    ...
    if (status === 'pending') {
        return (
            <div className="max-w-2xl mx-auto text-center space-y-8 py-[3px] lg:py-6">
                ...
                <p className="text-gsps-blue/60 font-medium">We are currently reviewing your documents. This usually takes 1-6 hours. We'll notify you once your account is approved.</p>
